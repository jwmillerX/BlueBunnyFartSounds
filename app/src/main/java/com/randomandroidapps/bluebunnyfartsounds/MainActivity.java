package com.randomandroidapps.bluebunnyfartsounds;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void playCommon(View view) {
        // Kabloey
        mp = MediaPlayer.create(this, R.raw.common_fart);
        mp.start();
    ...
    public void playTight(View view) {
        // Kabloey
        mp = MediaPlayer.create(this, R.raw.tight_bunn_fart);
        mp.start();
    ...
    public void playWet(View view) {
        // Kabloey
        mp = MediaPlayer.create(this, R.raw.wet_fart);
        mp.start();
    ...
    public void playRipper(View view) {
        // Kabloey
        mp = MediaPlayer.create(this, R.raw.ripper_fart);
        mp.start();
    ...
    public void playAnxious(View view) {
        // Kabloey
        mp = MediaPlayer.create(this, R.raw.anxious_fart);
        mp.start();
    ...
    public void playBlower(View view) {
        // Kabloey
        mp = MediaPlayer.create(this, R.raw.blower_fart);
        mp.start();
    ...
    public void playCoughing(View view) {
        // Kabloey
        mp = MediaPlayer.create(this, R.raw.coughing_fart);
        mp.start();
    ...
    public void playRidgeway(View view) {
        // Kabloey
        mp = MediaPlayer.create(this, R.raw.ridgeway);
        mp.start();
    ...
    public void playSmooth(View view) {
        // Kabloey
        mp = MediaPlayer.create(this, R.raw.smooth_fart);
        mp.start();
    ...
    public void playBean(View view) {
        // Kabloey
        mp = MediaPlayer.create(this, R.raw.bean_fart);
        mp.start();
